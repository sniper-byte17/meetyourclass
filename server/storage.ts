...
class StorageManager {
  ...
  createSubmission(data: Partial<StudentSubmission>): StudentSubmission {
    ...
    const newSubmission: StudentSubmission = {
      ...
      photoUrl: data.photoUrl || (data.photoUrls && data.photoUrls[0]) || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=800&q=80',
      photoUrls: data.photoUrls && data.photoUrls.length > 0 ? data.photoUrls : [data.photoUrl || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=800&q=80'],
